...
export const NarrativeSplitCard = ({
  ...
  return (
    <div
      className="group relative w-full overflow-hidden border border-[var(--border-subtle)] bg-[var(--surface)] transition-colors hover:border-[var(--border)]"
      data-testid="narrative-split-card"
    >
      {/* SEED HEADER */}
